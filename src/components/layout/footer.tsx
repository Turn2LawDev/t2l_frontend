...
const IconLogo = () => (
  <svg width="32" height="40" viewBox="0 0 62 79" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_0_8px_rgba(255,255,255,0.4)] hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.6)] transition-all duration-300">
...
const Footer = () => {
  return (
    <footer id="contact" className="bg-[#191919] text-white py-12 rounded-t-3xl mt-16">
      <div className="container mx-auto px-6 relative">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Logo and Tagline Section */}
          <div className="lg:col-span-2">
            <Link href="#home" className="flex items-center gap-3 mb-6 group" onClick={(e) => {
              e.preventDefault();
            ...
            <h2 className="text-3xl font-headline font-bold text-white mb-6 leading-tight">
              Simplifying legal access<br />to everyone.
            </h2>
          </div>
          
          {/* Links Section */}
          <div className="lg:col-span-1">
            <h3 className="font-headline font-semibold text-xl mb-6 text-white">Links</h3>
            <ul className="space-y-3 text-white/70 font-body">
              ...
              <li><Link href="#find-lawyer" className="hover:text-white transition-colors">Get a lawyer</Link></li>
              <li><Link href="#pricing" className="hover:text-white transition-colors">Pricing</Link></li>
              <li><Link href="#services" className="hover:text-white transition-colors">This</Link></li>
              <li><Link href="#testimonials" className="hover:text-white transition-colors">That</Link></li>
            </ul>
          </div>
          
          {/* Socials Section */}
          <div className="lg:col-span-1">
            <h3 className="font-headline font-semibold text-xl mb-6 text-white">Socials</h3>
            <ul className="space-y-3 text-white/70 font-body">
              <li><a href="#" className="hover:text-white transition-colors">LinkedIn</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Instagram</a></li>
              <li><a href="#" className="hover:text-white transition-colors">X</a></li>
              <li><a href="#" className="hover:text-white transition-colors">This</a></li>
              <li><a href="#" className="hover:text-white transition-colors">That</a></li>
            </ul>
          </div>
        </div>
        
        {/* Copyright */}
        <div className="mt-12 border-t border-white/20 pt-6 text-center text-white/50">
          <p className="font-body">Copyright &copy; {new Date().getFullYear()} Turn2Law. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
